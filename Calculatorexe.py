...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ''
        Entry(master, width=17, bg='#808080', font=('Arial Bold', 28), textvariable=self.equation).place(x=0, y=0)

        # Number Buttons
        Button(master, width=11, height=4, text='(', relief='flat', bg='#00FFFF', command=lambda: self.show('(')).place(x=0, y=50)
        Button(master, width=11, height=4, text=')', relief='flat', bg='#00FFFF', command=lambda: self.show(')')).place(x=90, y=50)
        Button(master, width=11, height=4, text='%', relief='flat', bg='#00FFFF', command=lambda: self.show('%')).place(x=180, y=50)
        ...
        Button(master, width=11, height=4, text='-', relief='flat', bg='#00FFFF', command=lambda: self.show('-')).place(x=180, y=350)
        Button(master, width=11, height=4, text='+', relief='flat', bg='#00FFFF', command=lambda: self.show('+')).place(x=270, y=275)
        Button(master, width=11, height=4, text='X', relief='flat', bg='#00FFFF', command=lambda: self.show('*')).place(x=270, y=200)
        Button(master, width=11, height=4, text='/', relief='flat', bg='#00FFFF', command=lambda: self.show('/')).place(x=270, y=50)
        Button(master, width=11, height=4, text='.', relief='flat', bg='#00FFFF', command=lambda: self.show('.')).place(x=270, y=125)
        Button(master, width=11, height=4, text='=', relief='flat', bg='#00FFFF', command= self.solve).place(x=270, y=350)
        Button(master, width=11, height=4, text='C', relief='flat', bg='#00FF00', command=self.clear).place(x=0, y=350)
